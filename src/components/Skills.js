            ...
            <ul className="skills-img">
                <li>
                    <div className="skill-icon-box">
                        <img
                            src={
                                process.env.PUBLIC_URL + "/images/photoshop.png"
                            }
                            alt="photoshop"
                        />
                    </div>
                ...
                <li>
                    <div className="skill-icon-box">
                        <img
                            src={process.env.PUBLIC_URL + "/images/scss.png"}
                            alt="scss"
                        />
                    </div>
                    <div className="skill-text-box">
                ...
                <li>
                    <div className="skill-icon-box">
                        <img
                            src={process.env.PUBLIC_URL + "/images/jira.png"}
                            alt="jira"
                        />
                    </div>
                    <div className="skill-text-box">
                ...
                <li>
                    <div className="skill-icon-box">
                        <img
                            src={
                                process.env.PUBLIC_URL + "/images/supabase.png"
                            }
                            alt="supabase"
                        />
                    </div>
