                    ...
                    <div className="info-section">
                        <ul>
                            ...
                            <li>
                                ...
                                <strong> - 지도 기능 부재</strong> <br />
                                아쉬운 점 : 현재 사용자가 자신의 위치에서 가까운
                                주차타워나 지역별 주차타워 위치를 확인할 수 있는
                                기능이 없어 원하는 곳의 주차타워를 직관적으로
                                선택하기 어렵습니다. <br />
                                개선 방향 : 내 위치 정보와 지도 기능을 추가하여,
                                유저가 원하는 위치의 주차타워를 쉽게 선택할 수
                                있는 플로우를 구현하겠습니다. <br />
                                <br />
                                <strong> - ID/PW 찾기 페이지 부재</strong>
                                <br />
                                아쉬운 점 : 계정 정보 복구를 위한 ID/PW 찾기
                                페이지가 없어 사용자가 정보를 잃었을 때 복구가
                                어렵습니다. <br />
                                개선 방향 : ID/PW 찾기 페이지를 개발하여 계정
                                정보 복구를 원활하게 지원하겠습니다. <br />
                                <br />
                                <strong> - 알림창 통일성 부족</strong> <br />
                                아쉬운 점 : 화면마다 알림창이 Alert과 팝업으로
                                두가지로 나누어져 있어서 통일성이 부족합니다.
                                <br />
                                개선 방향 : 모든 알림창을 팝업 형태로 통일하여
                                통일된 UX를 제공하겠습니다.
                                <br /> <br />
                            </li>
                            ...
                            <li>
                                ...
                                존재해 수정 및 유지보수가 어려웠고, 코드 양도 불필요하게
                                많았습니다. <br />
                                이를 해결하기 위해 반복되는 구조는 공통
                                컴포넌트로 만들고, props를 활용해 유연하게
                                재사용할 수 있도록 개선하였습니다. 이 과정에서
                                컴포넌트 간 역할을 명확히 나누고, 프로젝트
                                전체의 코드 일관성과 가독성을 높일 수
                                있었습니다.
                            </li>
                        </ul>
                    </div>
