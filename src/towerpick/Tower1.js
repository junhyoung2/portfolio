            ...
            <div className="content-container">
                <div className="form">
                    ...
                    <p className="description">
                        “TOWER PICK”은 사용자가 ‘지금 당장 주차해야 할 상황’ 을
                        고려해, 모바일에 최적화된 형태로 개발되었으며, 복잡한
                        도심 속 주차 문제를 해결하기 위해 개발된 ‘도심형
                        주차타워 전용’ 예약 서비스 앱 플랫폼 입니다
                    </p>
                    <div className="info-section">
                        <p className="info-title">제작에 사용된 스킬 :</p>
                        <p>
                            Figma / PhotoShop, React, SCSS, Supabase, GIT/GitHub
                        </p>
                    </div>
                    <div className="info-section">
                        ...
                        <ul>
                            ...
                            <li>
                                <span>레이아웃 제작 방식 :</span> grid 기반의
                                카드형 레이아웃으로 실제 화면을 구현하였습니다.
                            </li>
                            <li>
                                <span>플러그인 :</span> REACT-ICONS react-router
                                SCSS
                            </li>
                            <li>
