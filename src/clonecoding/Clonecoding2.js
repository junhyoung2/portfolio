        ...
        <div id="clone-coding">
            <div className="content">
                ...
                <div className="project">
                    ...
                    <p className="desc">
                        미디어 쿼리로 디바이스 크기에 따라 배경 이미지,
                        내비게이션, 비디오 비율을 유동적으로 조정했습니다.
                    </p>
                    ...
                    <div className="section">
                        <ul>
                            <li>
                                ...
                                구조를 분석한 뒤, HTML과 CSS를 활용해 실제
                                스타일을 재현하는 방식으로 구현하였습니다.
                            </li>
                            <li>
                                <span>레이아웃 제작 방식 :</span> <br />
                                Mobile First 원칙에 따라 모바일 화면을 기준으로
                                레이아웃을 설계하고, 미디어 쿼리를 활용해
                                데스크탑 해상도에서도 콘텐츠가 자연스럽게 재배치
                                되도록 구성하였습니다.
                            </li>
                            <li>
