                ...
                <div className="form">
                    ...
                    <div className="info-section">
                        <ul>
                            <li>
                                ...
                                <br /> Figma , Ririm는 ‘릴리(백합)’의 청초하고
                                순수한 이미지와 ‘꿈(Dream)’의 몽환적이고
                                감성적인 무드를 담은 이름으로, 두 단어를 조합해
                                탄생한 프로젝트입니다.
                            </li>
                        </ul>
                    </div>
                    <div className="info-section">
                        <ul>
                            ...
                            <li>
                                <span>레이아웃 제작 방식 :</span> <br />- Grid를
                                기반으로 구성했으며, 콘텐츠는 카드 형태로 정리해
                                일관성과 가독성을 높였습니다. Grid를 사용하면
                                다양한 화면 크기에서 반응형 배치를 쉽게 구현할
                                수 있고, 요소 간 간격과 정렬을 직관적으로 관리할
                                수 있어 유지보수와 수정을 염두에 두고
                                설계했습니다.
                            </li>
                            <li>
                            ...
                            <li>
                                <span>제작기간 :</span> <br /> - 07.07~07.11
                                (5D)
                            </li>
                            <li>
                                <span>제작 참여율 :</span> <br />- 80%(5인 팀
                                프로젝트)
                            </li>
                            <li>
                    ...
                    <ul className="meta-links">
                        <li>
                            <div className="nav-link" onClick={goToShopping2}>
                                <span>OVERVIEW ＞</span>
                            </div>
                        </li>
                        <li>
