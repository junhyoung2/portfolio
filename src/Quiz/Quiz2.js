                        ...
                        <ul>
                            <li>
                                ...
                                <li>
                                    ...
                                    시작하고, 질문과 답변을 카드 형태로
                                    순차적으로 확인할 수 있도록 구현하며, 버튼
                                    클릭을 통해 사용자가 답변을 확인하고 다음
                                    문제로 넘어가는 방식으로 구성하였습니다.
                                </li>
                            </li>
                            <br />
                            <li>
                                ...
                                <li>
                                    - 서비스 기획부터 전체 사용자 흐름 설계를
                                    직접 진행하였습니다.
                                </li>
                                <li>
                                    - REACT를 활용하여 컴포넌트 구조를 설계하고
                                    SCSS를 사용하여 스타일링, 변수 정리를 통하여
                                    일관되고 효율적인 디자인을 구현하였습니다.
                                </li>
                            </li>
                        </ul>
                    </div>
