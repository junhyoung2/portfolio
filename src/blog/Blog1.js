            ...
            <div className="content-container">
                <div className="form">
                    ...
                    <div className="info-section">
                        <ul>
                            <li>
                                ...
                                블로그형 웹사이트로,테마별 여행지 선택, AI 기반
                                추천 일정, 여행지 요약 정보 등을 제공하여 여행이
                                익숙하지 않은 사람들도 쉽게 접근할 수 있도록
                                설계된 서비스입니다.
                            </li>
                        </ul>
                    </div>
                    <div className="info-section">
                        <span className="info-title">- 프로젝트 개요</span>
                        <br />
                        <br />
                        <ul>
                            <li>
                                <span>UI 디자인 방식 :</span> <br />- DCOD Lab
                                웹사이트의 레이아웃 스타일을 참고하여 Figma에서
                                전체 UI 흐름과 비주얼 구조를 먼저 설계한 후,
                                이를 바탕으로 실제 화면을 구현하였습니다.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                Flexbox를 채택했습니다. <br />
                                또한, 카드 단위로 콘텐츠를 구분함으로써 시각적
                                일관성을 높이고, 사용자에게 정보 구조를 명확하게
                                전달할 수 있는 장점이 있어 카드 기반 레이아웃을
                                선택했습니다.
                            </li>

                            <li>
                                <span>제작기간 :</span> <br /> - 05.01~05.02
                                (2D)
                            </li>
                            <li>
                                <span>제작 참여율 :</span> <br />- 100%
                                (개인프로젝트)
                            </li>
                            <li>
                    ...
                    <ul className="meta-links">
                        <li>
                            <div className="nav-link" onClick={goToBlog2}>
                                <span>OVERVIEW ＞</span>
                            </div>
                        </li>
                        <li>
