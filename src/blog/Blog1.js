            ...
            <div className="content-container">
                <div className="form">
                    ...
                    <p className="description">
                        ...
                        일정, 여행지 정보 등을 제공하여 여행이 익숙하지 않은
                        사람들도 쉽게 접근할 수 있도록 설계된 서비스입니다.{" "}
                    </p>
                    ...
                    <div className="info-section">
                        ...
                        <ul>
                            <li>
                                <span>UI 디자인 방식 :</span> DCOD Lab
                                웹사이트의 레이아웃 스타일을 참고하여 Figma에서
                                전체 UI 흐름과 비주얼 구조를 먼저 설계한 후,
                                이를 바탕으로 실제 화면을 구현하였습니다.
                            </li>
                            <li>
                                <span>레이아웃 제작 방식 :</span> Flexbox를
                                중심으로 헤더와 메뉴를 구성하고, 섹션별 콘텐츠
                                정렬에도 유연하게 적용하였습니다. <br />
                                본문 영역은 Flex와 Grid를 혼합하여 구성함으로써
                                콘텐츠 유형에 따라 적절하게 배치하였고, SCSS
                                변수와 스타일 관리 구조를 도입해 전체적으로
                                일관된 비주얼을 유지할 수 있도록 하였습니다.
                            </li>
