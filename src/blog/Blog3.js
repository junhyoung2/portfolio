                    ...
                    <div className="info-section">
                        <ul>
                            ...
                            <li>
                                ...
                                <br/>아쉬운 점 : 반응형 구현을 시도했으나, 화면별
                                레이아웃 구조를 처음부터 고려하지 않아 CSS
                                구조를 재설계해야 하는 상황이 발생함. <br/>개선 방향 
                                : 다음 프로젝트에서는 초기 설계 단계부터
                                모바일·태블릿 레이아웃을 포함한 구조를 설계하고,
                                공통 컴포넌트 재사용을 통해 반응형 구현 효율을
                                극대화 하겠습니다.
                                <br />
                                   <br /><strong> - 서브 페이지 미구현 </strong>
                                <br/>아쉬운 점 : 메인 페이지만 구현한 후, 서브 페이지
                                구현을 고려하지 못해 전체 사이트 흐름과 콘텐츠
                                확장을 충분히 반영하지 못했습니다. <br/>개선 방향
                                : 다음 프로젝트에서는 페이지별 우선순위와
                                모듈화를 명확히 정의하고, 메인과 서브 페이지를
                                병행 개발할 수 있도록 계획을 수립하겠습니다.
                            </li>
                            <br />
