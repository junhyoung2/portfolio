            ...
            <div className="content-container">
                <div className="form">
                    ...
                    <p className="description">
                       Playmap은 사용자의 위치를 기반으로 주변 놀이 시설 정보를 탐색할 수 있도록 구성된 서비스로, 본 프로젝트는 그 초기 디자인과 UI/UX 설계에 집중하였습니다.
                    </p>
                    ...
                    <div className="info-section">
                        ...
                        <ul>
                            <li>
                                <span>UI 디자인 방식 :</span> Figma를 활용해 클릭 가능한 프로토타입을 직접 제작하였으며, 버튼 흐름과 화면 전환 등 사용자의 실제 인터랙션을 고려한 설계를 주도적으로 진행하였습니다.
                            </li>
                            <li>
                                <span>레이아웃 제작 방식 :</span> 레이아웃은 디자인 시스템을 기반으로 구성하였고, 버튼, 카드, 네비게이션 메뉴 등 반복적으로 사용되는 요소들을 컴포넌트화하여 구조적인 일관성을 유지했습니다.
                            </li>
